...
@section('content')
    ...
    <div class="panel panel-default register-login-head">
        <div class="panel-heading register-login-heading">{{ trans('labels.frontend.auth.login_box_title') }}</div>

        <div class="panel-body register-login-body">
