...
<div class="row" ><br>
    <div class="col-xs-12">
        ...
        <div class="col-sm-4" >
            ...
            <br>
            <a class="btn btn-primary" href="{{ route ('admin.restaurants.create',['restro_id'=>$restro->id]) }}">Edit Restaurant</a><br>
            <br>

            <a class="btn btn-primary" href="{{ route ('admin.restaurants.destroy',['restro_id'=>$restro->id]) }}">Delete Restaurant</a><br><br>
            <br>
